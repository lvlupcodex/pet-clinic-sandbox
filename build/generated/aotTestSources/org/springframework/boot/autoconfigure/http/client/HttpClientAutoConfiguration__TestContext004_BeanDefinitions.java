 ...
 */
@Generated
public class HttpClientAutoConfiguration__TestContext004_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<ClientHttpRequestFactoryBuilder> getClientHttpRequestFactoryBuilderInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ClientHttpRequestFactoryBuilder>forFactoryMethod(HttpClientAutoConfiguration.class, "clientHttpRequestFactoryBuilder", HttpClientProperties.class)
  ...
  private static BeanInstanceSupplier<ClientHttpRequestFactorySettings> getClientHttpRequestFactorySettingsInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ClientHttpRequestFactorySettings>forFactoryMethod(HttpClientAutoConfiguration.class, "clientHttpRequestFactorySettings", HttpClientProperties.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.http.client.HttpClientAutoConfiguration", HttpClientAutoConfiguration.class).clientHttpRequestFactorySettings(args.get(0), args.get(1)));
  }
