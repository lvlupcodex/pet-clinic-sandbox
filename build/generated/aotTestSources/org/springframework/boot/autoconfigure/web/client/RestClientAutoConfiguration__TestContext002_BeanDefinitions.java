...
public class RestClientAutoConfiguration__TestContext002_BeanDefinitions {
  ...
  private static BeanInstanceSupplier<AutoConfiguredRestClientSsl> getRestClientSslInstanceSupplier(
    ...
    return BeanInstanceSupplier.<AutoConfiguredRestClientSsl>forFactoryMethod(RestClientAutoConfiguration.class, "restClientSsl", ObjectProvider.class, SslBundles.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.client.RestClientAutoConfiguration", RestClientAutoConfiguration.class).restClientSsl(args.get(0), args.get(1)));
  }
