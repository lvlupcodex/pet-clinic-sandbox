...
public class DataSourcePoolMetricsAutoConfiguration__TestContext001_BeanDefinitions {
  ...
  public static class DataSourcePoolMetadataMetricsConfiguration {
    ...
    public static BeanDefinition getDataSourcePoolMetadataMeterBinderBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfiguration$DataSourcePoolMetadataMetricsConfiguration");
  ...
  public static class HikariDataSourceMetricsConfiguration {
    ...
    public static BeanDefinition getHikariDataSourceMeterBinderBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfiguration$HikariDataSourceMetricsConfiguration");
