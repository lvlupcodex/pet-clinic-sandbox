...
public class ObservationAutoConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<ObservationRegistry> getObservationRegistryInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ObservationRegistry>forFactoryMethod(ObservationAutoConfiguration.class, "observationRegistry")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration", ObservationAutoConfiguration.class).observationRegistry());
  }
  ...
  public static BeanDefinition getObservationRegistryBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration");
  ...
  private static BeanInstanceSupplier<PropertiesObservationFilterPredicate> getPropertiesObservationFilterInstanceSupplier(
    ...
    return BeanInstanceSupplier.<PropertiesObservationFilterPredicate>forFactoryMethod(ObservationAutoConfiguration.class, "propertiesObservationFilter", ObservationProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration", ObservationAutoConfiguration.class).propertiesObservationFilter(args.get(0)));
  }
  ...
  public static class ObservedAspectConfiguration {
    ...
    private static BeanInstanceSupplier<ObservedAspect> getObservedAspectInstanceSupplier() {
      return BeanInstanceSupplier.<ObservedAspect>forFactoryMethod(ObservationAutoConfiguration.ObservedAspectConfiguration.class, "observedAspect", ObservationRegistry.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration$ObservedAspectConfiguration", ObservationAutoConfiguration.ObservedAspectConfiguration.class).observedAspect(args.get(0)));
    }
    ...
    public static BeanDefinition getObservedAspectBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration$ObservedAspectConfiguration");
  ...
  public static class OnlyMetricsConfiguration {
    ...
    private static BeanInstanceSupplier<ObservationHandlerGrouping> getMetricsObservationHandlerGroupingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<ObservationHandlerGrouping>forFactoryMethod(ObservationAutoConfiguration.OnlyMetricsConfiguration.class, "metricsObservationHandlerGrouping")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration$OnlyMetricsConfiguration", ObservationAutoConfiguration.OnlyMetricsConfiguration.class).metricsObservationHandlerGrouping());
    }
    ...
    public static BeanDefinition getMetricsObservationHandlerGroupingBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration$OnlyMetricsConfiguration");
    ...
    public static class OnlyMetricsMeterObservationHandlerConfiguration {
      ...
      private static BeanInstanceSupplier<DefaultMeterObservationHandler> getDefaultMeterObservationHandlerInstanceSupplier(
        ...
        return BeanInstanceSupplier.<DefaultMeterObservationHandler>forFactoryMethod(ObservationAutoConfiguration.MeterObservationHandlerConfiguration.OnlyMetricsMeterObservationHandlerConfiguration.class, "defaultMeterObservationHandler", MeterRegistry.class, ObservationProperties.class)
                .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration$MeterObservationHandlerConfiguration$OnlyMetricsMeterObservationHandlerConfiguration", ObservationAutoConfiguration.MeterObservationHandlerConfiguration.OnlyMetricsMeterObservationHandlerConfiguration.class).defaultMeterObservationHandler(args.get(0), args.get(1)));
      }
      ...
      public static BeanDefinition getDefaultMeterObservationHandlerBeanDefinition() {
        ...
        beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.observation.ObservationAutoConfiguration$MeterObservationHandlerConfiguration$OnlyMetricsMeterObservationHandlerConfiguration");
